<template>
	...
	<div class="flex align-stretch" @click="onClick" @longpress="long">
		...
		style="width: 145rpx;">
			<fss-avater :src="item.avatar" size="92"></fss-avater>
			<fss-badge badgeClass="position-absolute"
			badgeStyle="top:15rpx;right:15rpx"
			v-if="item.noreadnum" :value="item.noreadnum"></fss-badge>
		</view>
...
<script>
	import fssBase from "@/common/mixin/com-base.js"
	
	import fssAvater from "@/components/ui/ui-avater.vue"
	import fssBadge from "@/components/ui/ui-badge.vue"
