<template>
	<view>
		...
		<!-- 弹出层 -->
		<fss-popup ref="extend" :bodyWidth="240" :bodyHeight="getMenusHeight">
...
<script>
	import fssNavBar from "@/components/ui/ui-nav-bar.vue"
	import fssMediaList from "@/components/ui/ui-media-list.vue"
	
	import fssPopup from "@/components/ui/ui-popup.vue"
